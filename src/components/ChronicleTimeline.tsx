                  ...
                  <div
                    ...
                    style={{
                      background: isYearOpen
                        ? "linear-gradient(180deg, oklch(0.72 0.13 80) / 80%, transparent)"
                        : "linear-gradient(180deg, oklch(0.72 0.13 80) / 20%, transparent)",
                    }}
                    aria-hidden="true"
                  />
                )}
      ...
      <li className="relative min-w-0">
        <div className="relative grid grid-cols-[1.5rem_1fr] gap-x-3 sm:grid-cols-[2rem_1fr] sm:gap-x-5 md:gap-x-6 items-start">
          ...
          <div className="relative">
            <div
              className="card-arcane card-arcane-hover relative overflow-hidden rounded-xl px-4 py-6 sm:p-8 text-center animate-fade-up"
              style={{ borderColor: "oklch(0.72 0.13 80 / 0.3)" }}
            >
              <div className="relative z-10">
                ...
                <p className="mt-2 font-body text-sm leading-relaxed text-muted-foreground max-w-md mx-auto sm:text-base">
                  Every adventurer who joins adds a page. Every run teaches a new lesson. The
                  chronicle continues with those who believe that understanding the dungeon is the
